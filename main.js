...
const fetchUnreadMessages = () => interval(5000).pipe(switchMap(() => ajax.getJSON('http://localhost:3000/messages/unread').pipe(map(response => response.messages), catchError(error => {
